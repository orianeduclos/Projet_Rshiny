...
Afin de faciliter notre travail nous avons décidé d'utiliser git. Via le terminal, nous avons travaillé en effectuant des push et des pull. 

## Répartition des tâches

Nous nous sommes réparties les tâches au fur et à mesure de l'avancée de l'application. 

## Notre ressenti

Nous avons beaucoup aimé travailler sur le thème des naissances. Avoir différentes échelles à étudier nous a permis de ne pas nous répéter, d'autant plus que nous avons utiliser plusieurs outils de visualisation différensts. 
